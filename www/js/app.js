...
if (!isInDevMode && !prodReady) {
    constants.fieldPromaxApi =
        "https://fieldpromax-stagging1.azurewebsites.net/"; //"http://192.168.100.42:81/";
}
var db = null;
var fpm = angular
    .module("fpm", [
            ...
            var routes = [
                ...
                },
                {
                    ...
                    config: {
                        ...
                        controllerAs: "vm",
                        templateUrl:
                            "js/offline/edit.order.page.controller.html"
                    }
                },
                {
                ...
                },
                {
                    ...
                    config: {
                        url: "/messageHub",
                        controller: "message-hub-page-controller",
                        controllerAs: "vm",
                        templateUrl:
                            "js/message-hub/message.hub.page.controller.html"
                    }
                },
                {
                    state: "app.messageHubDetails",
                    cache: false,
                    config: {
                        url: "/messageHubDetails/:sender",
                        controller: "message-hub-chat-details-controller",
                        controllerAs: "vm",
                        templateUrl:
                            "js/message-hub/message.hub.chat.details.controller.html"
                    }
                },
                {
                    state: "app.logout",
        ...
        function (
            ...
            $ionicPlatform.ready(function () {
                ...
                function succesFn(location) {
                    var credentials =
                        authenticationFactory.getStoredCredentials();
                ...
                if (!isInDevMode) {
                    ...
                    bgGeo.on(
                        "motionchange",
                        function (isMoving, location, taskId) {
