(function() {
  ...
  function initFactory(apicontext) {
    ...
    function unattachEquipToBarcode(barcode, equipNum) {
      return apicontext.get(
        apiBase +
          "UnattachEquipToBarcode?barcode=" +
          barcode +
          "&equipNum=" +
          equipNum
      );
    ...
    function getBarcodeEquipments(barcode) {
      return apicontext.get(
        apiBase + "GetBarcodeEquipments?barcode=" + barcode
      );
    }

    function getEquipmentFields(equipNum, barcode) {
      return apicontext.get(
        apiBase + "GetEquipmentFields?barcode=" + barcode + "&num=" + equipNum
      );
    }
    ...
    function getCustomDefaultTypes() {
      return apicontext.get(
        "/api/CustomTypes/GetCustomTypes?entityType=101&entityId=0"
      );
    }

    factory.getCustomDefaultTypes = getCustomDefaultTypes;
