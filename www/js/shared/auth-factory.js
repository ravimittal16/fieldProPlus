            ...
            function onLoginSuccess(response) {
                if (response) {
                    ...
                    var userobj = {
                        ...
                        timecardAccessLevel: +(
                            response.timecardAccessLevel || 1
                        ),
                    ...
                    if (
                        response.hasOwnProperty(localStorageKeys.configKeyName)
                    ) {
                        localStorageService.set(
