(function () {
    ...
    function initFactory(
        ...
        function convertToBlob(base64Data, name) {
            ...
            var byteArrays = [];
            var totalLoopLength =
                Math.floor(byteCharacters.length / sliceSize) + 1;
            var loopCount = 0;
            for (
                var offset = 0;
        ...
        function clearLocationData() {
            return apiBaseFactory.get(locationapi + "ClearLocationData");
        }

        function downloadImageFromBlob(imageId, thumb) {
            return apiBaseFactory.downloadBlobFile(
                apibaseurl +
                    "DownloadImageFromBlob?imageId=" +
                    imageId +
                    "&thumb=" +
                    thumb
            );
        ...
        return {
            ...
            registerUserTemplateForPushNotifications:
                registerUserTemplateForPushNotifications,
