(function () {
    ...
    var componentConfig = {
        ...
        templateUrl:
            "js/work-orders/order-signature-card-component.template.html",
        controller: [
            "$scope",
            "$stateParams",
            "$timeout",
            ...
            function (
                ...
                vm.nextWorkdayAppointmentConfirmed = false;
                ...
                vm.imageUrl =
                    baseUrl + "Handlers/GetBarcodeSignature.ashx?barcode";
                vm.$onInit = function () {
                    vm.showNextWorkdayApppointmentCheckbox =
                        user && user.customerNumber === "193514633790019";
                    console.log(vm.showNextWorkdayApppointmentCheckbox);
                    if (vm.isEstimate) {
