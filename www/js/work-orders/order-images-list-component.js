(function () {
    ...
    var componentConfig = {
        ...
        controller: ["$scope", "$ionicModal", "work-orders-factory", "fpm-utilities-factory", "fieldPromaxConfig",
            function ($scope, $ionicModal, workOrdersFactory, fpmUtilitiesFactory, fieldPromaxConfig) {
                var vm = this;
                vm.isExpanded = false;
                ...
                vm.upload = {
                    ...
                    uploadImage: function (rawImage, imageName) {
                        workOrdersFactory.uploadFile({ Barcode: vm.barcode, Image: rawImage, Name: imageName }).then(function (response) {
                            vm.barcodeImages.push({ barcode: vm.barcode, fileName: imageName, imageURL: "/" + imageName, num: response });
