(function () {
    ...
    function initFactory($q, $rootScope, $cacheFactory, apiBaseFactory) {
        ...
        function getBarcodeInvoiceAndProductDetails(barcode) {
            return apiBaseFactory.get(
                apibaseurl +
                    "GetBarcodeInvoiceAndProductDetails?barcode=" +
                    barcode
            );
        }
        ...
        function saveJsonSignForBarcode(obj) {
            ...
            return apiBaseFactory.post(
                apibaseurl + "SaveJsonSignForBarcode",
                obj
            );
        }
        ...
        function updateWorkOrderMobile(model) {
            ...
            return apiBaseFactory.post(
                apibaseurl + "UpdateWorkOrderMobile",
                model
            );
        }
        ...
        function addWorkOrderSchedule(schedule) {
            return apiBaseFactory.post(
                apibaseurl + "AddWorkOrderSchedule",
                schedule
            );
        }
        ...
        function updateCustomScheduleData(o) {
            return apiBaseFactory.post(
                apibaseurl + "UpdateCustomScheduleData",
                o
            );
        }
        ...
        function getWorkOrderResolution(id) {
            return apiBaseFactory.get(
                apibaseurl + "GetWorkOrderResolution?id=" + id
            );
        }
        ...
        function getBarcodeInvoiceAndScheduleDetails(barcode) {
            return apiBaseFactory.get(
                apibaseurl +
                    "GetBarcodeInvoiceAndScheduleDetails?barcode=" +
                    barcode +
                    "&loadSchedules=false"
            );
        }
        ...
        return {
            ...
            getBarcodeInvoiceAndProductDetails:
                getBarcodeInvoiceAndProductDetails,
            ...
            getBarcodeInvoiceAndScheduleDetails:
                getBarcodeInvoiceAndScheduleDetails
        };
    }
    initFactory.$inject = [
