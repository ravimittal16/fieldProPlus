(function () {
  ...
  var componentConfig = {
      ...
      controller: ["$scope", "$stateParams","authenticationFactory","work-orders-factory", "fieldPromaxConfig","fpm-utilities-factory","$timeout",
          function ($scope, $stateParams, authenticationFactory,workOrderFactory, fieldPromaxConfig,fpmUtilities,$timeout) {
              var vm = this;
              ...
              var paymentSchema = {paymentMode: "", receivedDate: new Date(), barCode: vm.barcode, paymentMemo: "", amountReceived:0.00, serviceProviderEmail:""};
