(function () {
      ...
      function ($scope, $timeout, $ionicModal, fpmUtilitiesFactory, workOrderFactory, authenticationFactory, inventoryDataFactory) {
        ...
        function openEditProductQuantityModal() {
          if (vm.productModal) {
            ...
            fpmUtilitiesFactory.getModal("editProductModal.html", $scope).then(function (modal) {
        ...
        $scope.$on("$fpm:operation:updateContainerProductQuantity", function ($event, args) {
          inventoryDataFactory.getContainerProducts(vm.container.containerName).then(function (response) {
  ...
  angular.module("fpm").component("inventoryContainerViewComponent", componentConfig);
})();
